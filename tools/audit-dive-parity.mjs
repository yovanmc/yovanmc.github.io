// Timeline parity audit: the generated diveTimeline module must produce
// byte-identical state to the lab's pure block, evaluated standalone, across
// the full timeline. This checks the EXTRACTOR only; the render port is
// checked separately in the browser with per-beat DOM assertions.
