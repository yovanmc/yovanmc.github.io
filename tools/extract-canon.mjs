...
function battleHeader(source, note) {
  return `// @ts-nocheck
/* eslint-disable */
// GENERATED by tools/extract-canon.mjs from the design lab source ${source}.
...
function buildHeroModule(body) {
  return battleHeader("hero-battle.html", "Conviction/Rollback/Root-Cause reels are extracted but unused by the starting ability kit.") +
    body + "\n" +
