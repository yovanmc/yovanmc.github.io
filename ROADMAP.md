...
| M3b | Game/portfolio separation + intro integration (phase machine intro→gate→play\|browse, `/browse` path, path-preserving 404) | 📝 This PR | [plan](docs/superpowers/specs/2026-07-28-m3-split-plan.md) | — | **Supersedes S5's "v1 faked dive" line** (owner 2026-07-28) — the dive ships here |
