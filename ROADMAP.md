...
Shipped milestones leave this table: S1a/S1b/S2, M1–M2, M6, and now **M4, M7 and M12** live in `docs/roadmap-archive-2026-07.md`, with their retros in `docs/LESSONS.md`. The table carries current and future work only (owner ruling 2026-08-02) — an archived row's still-open owner items stay in the decision log below. Per-milestone detail lives in the linked plan docs above.
