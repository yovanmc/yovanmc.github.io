...
| M6 | Bosses 2-4 (Cascade, Silent Failure, Imposter Syndrome) | 🔨 In progress | [plan](docs/superpowers/specs/2026-07-28-m6-bosses-2-4-plan.md) | #22 #23 | Four-PR delivery. 1a (multi-boss engine, derived rider/kit, Fan Out) + 1b (the Cascade fight, FIGHT chooser) MERGED + LIVE 2026-07-28, 211 tests. Next: PR-2 Silent Failure (owner re-confirms its numbers table first), then PR-3 Imposter finale |
