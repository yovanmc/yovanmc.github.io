...
| M5 | Battle engine + the Alert Storm fight (pure TDD'd turn-discrete reducer + vitest suite; lazy-loaded battle scene composed from lab primitives; dive lands in battle) | 🔨 In progress | [plan](docs/superpowers/specs/2026-07-28-be1-battle-engine-plan.md) | — | Owner-ordered 2026-07-28 (pierces the freeze for this S5-class work). Three PRs: A engine+tests · B scene behind a FIGHT command · C dive→battle reroute. Bosses 2–4 follow on the proven engine |
