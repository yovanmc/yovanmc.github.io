 ...
 * Alert-Storm-corrupted arena used at battle start. The SPR actor
 * literal and compose/composeER are excluded from the slice because the
 * renderer owns actor placement. PAL comes from diveTimeline.
 */
