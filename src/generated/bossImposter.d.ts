 ...
 * (boss-imposter-syndrome.html lines 372-444, file 469 lines). Unlike every
 * other boss module, this one is not self-contained: it imports
 * IDLE/ATK/overlay/flashOf/ROWS/COLS from heroBattle.js and recolors
 * the hero's own frames (the "stolen technique" effect) rather than declaring
