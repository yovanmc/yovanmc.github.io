// GENERATED by tools/measure-figure-type.mjs. DO NOT HAND-EDIT: regenerate it
// with that script, which measures a real headless-Edge render after waiting
// on `document.fonts.ready` and confirming JetBrains Mono (not a fallback
// face) resolved.
