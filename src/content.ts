/** Content model for the RPG command menu, plus the copy it renders. */
...
export interface Item {
  title: string;
  /** stable URL segment for routing and static share shells; never derived from title at runtime */
  slug?: string;
  meta: string;
  stat: string;
  body: string;
