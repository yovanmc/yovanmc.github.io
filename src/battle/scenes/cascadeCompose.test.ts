...
describe("composeCascade — semantic guard: living-unlit core is never a stray lit/afterglow read", () => {
  ...
  it("a living non-carrier node whose core has no link overlap reads a clean N", () => {
    // node 0 and node 2 at bob 0 have no link dots over their core cells
