// The Cascade's scene module: banner telegraph threshold (including the CT
// extra-turn rule), composeBoss dispatch, and the static module shape
// (arena/plate/reels/copy).
...
describe("cascadeScene.banner — storm telegraph (stormIn threshold, CT shows one turn earlier)", () => {
  ...
  it("is empty for a non-cascade boss state", () => {
